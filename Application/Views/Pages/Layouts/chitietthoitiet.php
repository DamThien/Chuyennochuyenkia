    ...
    <section class="">
        <div class="content">
            <div class="contentkinhte-right">
                ...
                if (isset($_SESSION['thoitiet'])) {
                    foreach ($_SESSION['thoitiet'] as $key => $row) {
                ?>
                        ...
                        <div class="contentkinhte_steep1">
                            ...
                            <div class="right-content">
                                ...
                                <a href="http://localhost/CHUYENNOCHUYENKIA/Chuyennochuyenkia/Application/Controllers/chitietthoitiet.controller.php?ID=<?php echo $key ?>">
